...
// ⚠️ Function Name Must be generateLeaderboard()

// Programming Hero-এর নতুন AI Coding Arena-তে প্রতিদিন হাজার হাজার শিক্ষার্থী Problem Solve করে। দিন শেষে একটি AI Leaderboard Engine Top Performer-দের তালিকা তৈরি করে।
...
// কিন্তু সমস্যা হলো... একজন Junior Developer তাড়াহুড়ো করে পুরো Function লিখে ফেলেছে। সে ES6 Feature ব্যবহার করার চেষ্টা করেছে, কিন্তু অনেক জায়গায় ভুল করেছে। এখন Leaderboard ভুল Result দিচ্ছে। তোমার কাজ হলো সব Bug খুঁজে বের করে ঠিক করা।
...
// ]
// 🚀 Output:
// একটি Array, যেমনঃ ["RAFI", "KARIM", "NAFIS"]
...
// }
// 💡 Hints:
// এই Function-এ ৮টিরও বেশি Bug আছে। খেয়াল করে দেখো—

// Array.isArray() সঠিকভাবে ব্যবহার করা হয়েছে কি?
// Empty Array Check ঠিক আছে কি?
// filter() Callback কি Return করছে?
// Condition অনুযায়ী Score ঠিকভাবে Filter হচ্ছে? (70 বা তার বেশি)
...
// Example 1
// Input:
// generateLeaderboard([{"name":"Rafi","score":90},{"name":"Sadia","score":65},{"name":"Karim","score":85},{"name":"Nafis","score":75}])
// Expected Output:
// ["RAFI","KARIM","NAFIS"]
// Example 2
// Input:
// generateLeaderboard([{"name":"A","score":70},{"name":"B","score":71}])
// Expected Output:
// ["A","B"]
// Example 3
// Input:
